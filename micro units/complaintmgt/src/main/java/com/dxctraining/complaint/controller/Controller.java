package com.dxctraining.complaint.controller;
...
import com.dxctraining.complaint.dto.ConsumerDto;
import com.dxctraining.complaint.dto.CreateComplaintRequest;
import com.dxctraining.complaint.entites.Complaint;
import com.dxctraining.complaint.service.IService;
import com.dxctraining.complaint.util.ComplaintUtil;
...
public class Controller {
	...
	public ComplaintDto add(@RequestBody CreateComplaintRequest request) {
		...
		int consumerId = request.getConid();
	...
	public ComplaintDto get(@PathVariable("id") int id) {
		...
		int consumerId = complaint.getId();
		ConsumerDto consumerDto = fetchFromConsumerById(consumerId);
		ComplaintDto response = util.complaintDto(complaint, consumerId, consumerDto.getName());
		return response;
	}
